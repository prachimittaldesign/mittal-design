...
export function MusicPlayer() {
  ...
  return (
    <>
      {/* ── Mobile: single icon button, bottom-left, matching the Layers /
           map-control glass buttons. Not playing → tap plays (and advances
           to the next track); playing → tap stops. ── */}
      <div className="pointer-events-auto absolute bottom-[calc(1rem+env(safe-area-inset-bottom))] left-3 z-20 sm:hidden">
        <button
...
function EqualizerIcon() {
  return (
    <svg viewBox="0 0 18 18" className="h-[18px] w-[18px]" fill="currentColor">
